...
To authenticate requests, exchange your API key credentials at the shared `/authenticate/token` endpoint using HTTP Basic Authentication. Then include the one-hour token in the request headers when calling protected endpoints.
...
See **Modular API Reference** > **Webhooks** > **Create Webhook**.
...
See **Modular API Reference** > **Tenants** > **Create Tenant**.
...
See **Modular API Reference** > **Tenants** > **Upload Tenant Documents**, **Get Tenant Documents**, and **Initiate Cl@ve**.

## Identity verification

KYC verifies the tenant's identity using official identity documents.

See **Modular API Reference** > **Tenants** > **Initiate KYC**.

## Financial scoring

Banking data is analyzed and used in financial assessments.

See **Modular API Reference** > **Tenants** > **Initiate Bank**.
...
See **Modular API Reference** > **Tenants** > **Run Forensic Analysis**.

## End-to-end flow

<Steps>
  <Step title="Generate an access token">
    Generate an access token at `/authenticate/token` using your API key credentials via HTTP Basic Authentication. Use this token to authenticate all subsequent API requests.
  </Step>
