...
<Steps>
  ...
  <Step title="List accessible workspaces">
    Retrieve the landlord's workspaces with [List Accessible Workspaces](/api-reference/workspace/list-accessible-workspaces) and select the public `workspace_id` for subsequent requests.
  </Step>
